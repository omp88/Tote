...
<c:if test="${message != null}">
 ...
 <c:remove var="error" scope="session" />
	...
	<form class="register-form" action="Controller" method="POST">
		<input type="hidden" name="command" value="authorized"/>
		<div class="form-row">
			<label><fmt:message key="text.login"/></label>
			<input class="form-control" type="text" name="login" maxlength="40"  required/>
		</div>
		<div class="form-row">
	...
	<h2 class="form-label"><fmt:message key="text.login_for_admin"/></h2>
	<form  class="register-form" action="Controller" method="POST">
